...
{
case 1:
System.out.println("Q." + i + " how much is " + first + " adding " + second + "?");
break;
case 2:
System.out.println("Q." + i + " how much is " + first + " times " + second + "?");
break;
case 3:
System.out.println("Q." + i + " how much is " + first + " substracting " + second + "?");
break;
case 4:
System.out.println("Q." + i + " how much is " + first + " divides by " + second + "?");
break;
}
